...
- [Before You Begin](https://cloud.google.com/bigquery/docs/quickstarts/load-data-console#before-you-begin)
- [Create a Dataset](https://cloud.google.com/bigquery/docs/quickstarts/load-data-console#create_a_dataset)
- [Download the source Data File](https://cloud.google.com/bigquery/docs/quickstarts/load-data-console#download_the_source_data_file)
- [Load data into table](https://cloud.google.com/bigquery/docs/quickstarts/load-data-console#load_data_into_a_table)
...
Create the `bq` query Connection

<ConnectOnHoopButton text='Create Connection'
  url="http://127.0.0.1:8009/connections/command-line/new?data=eyJuYW1lIjoiYnFxdWVyeSIsInR5cGUiOiJjb21tYW5kLWxpbmUiLCJzZWNyZXQiOnsiZmlsZXN5c3RlbTpLRVlfRklMRSI6IiJ9LCJjb21tYW5kIjpbImJxIiwgInF1ZXJ5IiwgIi0tdXNlX2xlZ2FjeV9zcWw9ZmFsc2UiLCAiLS1qb2JfaWQiLCAiJEhPT1BfU0VTU0lPTl9JRCJdLCAiYWdlbnRfaWQiOiAiIn0="
/> <br /> <br />
...
```shell
hoop exec -v bq -i 'SELECT * FROM babynames.names_2014 LIMIT 1'
```
...
```shell
hoop bqhead -- --job_id <PREVIOUS_SESSION_ID>
```
